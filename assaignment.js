...
function pandaCost(totalSingara, totalSamucha, totalJilapi) {
    ...
    if ((totalSingara < 0) || (totalSamucha < 0) || (totalJilapi < 0)) {
        ...
        return totalCost = totalSingaraCost + totalSamuchaCost + totalJilapiCost;
    }
}

console.log(pandaCost(10, 13, 7));
...
function oddFriend(friendName) {
    ...
    return "Enter your odd friend name in array list";
}

console.log(oddFriend(["Jahedul", "Najim", "Abrar", "Kapil", "Hamid"]));